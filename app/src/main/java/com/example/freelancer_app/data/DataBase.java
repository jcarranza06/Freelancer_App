...
public class DataBase {
    ...
    public static String addUsuario(String nombre, String clave) {
        URL=BaseURL+"agregarUsuario.php?nombre="+nombre+"&clave="+clave+"&correo=-&pais=-&descripcion=-";
    ...
    public static String addServicio(int idPropietario, int calificacion, String descripcion, String titulo) {
        URL=BaseURL+"agregarServicio.php?idPropietario="+idPropietario+"&calificacion="+calificacion+"&descripcion="+descripcion+"&plazo=-&precio=-&titulo="+ titulo;
